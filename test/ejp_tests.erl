...
getter_jsonptr_test() ->
	...
	?assertEqual(ModelValue0, ejp:get(<<"/k">>,Model)),
	?assertEqual(ModelValue1, ejp:get(<<"/a/000">>,Model)),
	?assertEqual(ModelValue2, ejp:get(<<"/a/0/s1/001/l1_2">>,Model)),
	?assertEqual(ModelValue3, ejp:get(<<"/empty/01">>,Model)),
	ok.
...
setter_jsonptr_test() ->
	...
	?assertEqual(NewModel, ejp:set("/empty/00000001", Model, NewModelValue)),
	ok.
